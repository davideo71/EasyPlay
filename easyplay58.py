"""
EasyPlay v58 - Accessible Media Player for Raspberry Pi 5.
...
def play_video_embedded(screen, path, start_sec, show_seek_overlay=True,
    ...
    try:
        ...
        while running:
            ...
            # ── Blit cached scaled frame (letterboxed to preserve aspect ratio) ──
            screen.fill((0, 0, 0))
            ...
            # While seeking, keep 30fps so the overlay feels responsive.
