"""
EasyPlay v56 - Accessible Media Player for Raspberry Pi 5.

Changes from v55:
  - clean_media_name() rewritten with a comprehensive noise-pattern list
    ported from tools/fetch_covers.py. Now correctly strips size tags
    (900MB / 1400MB / 1.5GB), release group tags (-GalaxyRG, -GalaxyTV,
    -ION265, SuccessfulCrab), lowercase-content brackets ([i_c],
    [eztv.re], [TGx]), and standalone HMAX / WEB / H264 tokens.

v55 original notes below.
...
_CLEAN_PATTERNS = [
    ...
    r"\bDDP?\b",
    r"\b[257][\.\s]?[01]\b",
    r"\bAAC\d*(?:\.\d)?\b", r"\bAC3\b", r"\bDTS(?:-HD)?(?:\.MA)?\b",
    r"\bTrueHD\b", r"\bAtmos\b", r"\bFLAC\b", r"\bMP3\b",
    r"\bEAC3\b", r"\bE-AC-3\b", r"\bOPUS\b", r"\bOGG\b",
